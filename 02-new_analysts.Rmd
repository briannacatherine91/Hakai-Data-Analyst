...
You'll notice that this file is a '.Rmd' file which stands for R  Markdown. This is a plain text file that uses a minimal number of symbols to render the output text into something elegant and simple. Using plain text files for your analyses and for storing on gitHUB is recommended because almost any operating system can read them and they are most likely to be readable in the distant future, rather than using a proprietary file formats like word. [Read this](https://guides.github.com/features/mastering-markdown/) if you're interested in markdown syntax, otherwise come back to it later.
...
* Start making some awesome graphs by working through [section 3.1 to 3.5 in Hadley Wickham's R for Data Science Book](http://r4ds.had.co.nz/data-visualisation.html)
